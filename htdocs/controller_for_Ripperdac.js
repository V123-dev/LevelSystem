...
const container = document.querySelector(".levelup_inline_area");

Levelup_Array = [];
localStorage.setItem('Levelup_Array', JSON.stringify(Levelup_Array));
System_Array = [];
localStorage.setItem('System_Array', JSON.stringify(System_Array));
Delete_Array = [];
...
function Data_Parsing()
{
    ...
    */
    ...
    //데이터 추가
    var Temp_Array = JSON.parse(localStorage.getItem('System_Array')); //[1, 2, 3]
